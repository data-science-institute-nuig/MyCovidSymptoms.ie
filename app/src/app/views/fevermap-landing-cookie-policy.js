...
class FevermapLandingCookiePolicy extends LitElement {
  ...
  renderPolicy() {
    ...
    site to recognise your web browser when you return, additional data that serves the purpose
    of the cookie, and the lifespan of the cookie itself.
    <h3>How We Use Cookies</h3>
    We use a single cookie, which is the minimum amount of cookies necessary for
    MyCovidSymptoms to function. While you may disable cookies, it is recommended that you
    leave on all cookies if you are not sure whether you need them or not in case they are used to
    provide a service that you use. Our single cookie can be deleted by you at any time under
    ...
    Surveys related cookies: We user cookies to store some of your response information so that
    you do not have to repeatedly enter details that never or infrequently change. Namely, we
    store your response to the year of birth, gender and location questions. Additionally, we store
    an anonymised date stamp unique identifier for your entry device so that we know which
    symptoms come from the same person. The project team will conduct a deletion of their copy of this
    identifier within 90 days of the data collection completing.
    <h3>Third Party Cookies</h3>
    We do not use any third party cookies
    <h3>Further Information</h3>
    If you want more information you can contact us via email at: mycovidsymptoms@gmail.com
    `
  }
